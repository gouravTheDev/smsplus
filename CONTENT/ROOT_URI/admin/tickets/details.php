        ...
        <div class="col-md-8 col-sm-12">
            ...
            if ($_POST['submitReply']) {
                ...
                if ($replyText && $replyText != '') {
                    ...
                    $stmt2 = $link->prepare("UPDATE TICKETS SET `STATUS` = ? WHERE TICKET_ID = ?");
                    $st = 'Answered';
                    $stmt2->bind_param("ss", $st, $ticketId);

                    $resultUpdate = $stmt2->execute();
            ...
            <div class="card shadow">
                <div class="card-body">
                    <form method="POST">
                        ...
                        <textarea class="form-control mb-1" rows="2" placeholder="Write a Reply" name="replyText" required></textarea>
