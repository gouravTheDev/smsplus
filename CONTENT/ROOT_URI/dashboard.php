        ...
        <div class="card shadow" style="background: #2F90F0;">
            <div class="card-body text-center">
                <?php if ($profilePic && $profilePic != '') : ?>
                    <img src="CONTENT/UPLOADS/PROFILE_PIC/<?php echo $userId ?>/<?php echo $profilePic; ?>" alt="user-img" width="80" height="80" class="mb-2" style="border-radius: 50%; border: 1px solid #D9CEDE;">
                <?php else : ?>
                    <img src="assets/images/user.png" alt="user-img" width="80" height="80" class="mb-2" style="border-radius: 50%; border: 1px solid #D9CEDE;">
                <?php endif; ?>
